  ...
  return (
    <div className="flex w-[1440px] h-[604.36px] justify-center absolute top-[1190px] text-black ">
      ...
      <div className="flex items-center w-[1440px] h-[52px] ">
        <p className="w-[161px] h-[27px] absolute top-[13px] left-12 text-[22px] leading-7">
          Best of Air Max
        </p>
      ...
      <div className="flex w-[1440px] h-[540px] absolute top-[64px] items-center ">
        <div
          id="1"
          className="w-[441px] h-[510px] absolute left-[48px] border-[1px] border-tranparent hover:border-[1px] hover:border-black "
        >
          ...
          <div className="flex w-[425px] h-12 absolute top-[462px]">
            <div className="w-[134px] pr-[4px]">
              ...
              <p className="w-[109px] h-6 text-[15px] text-[#757575]">
                Women's Shoes
              </p>
            </div>
            <p className="w-[61px] h-[17px] absolute top-[3px] left-[363px] text-[15px]">
              ₹ 13 995
            </p>
          </div>
        </div>
        <div
          id="2"
          className="w-[441px] h-[510px] absolute left-[501px] border-[1px] border-tranparent hover:border-[1px] hover:border-black"
        >
        ...
        <div
          id="3"
          className="w-[441px] h-[510px] absolute left-[954px] border-[1px] border-tranparent hover:border-[1px] hover:border-black"
        >
