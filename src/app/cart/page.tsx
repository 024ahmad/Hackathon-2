...
// const Cart = () => {
//   return (
//     <div className='w-full max-w-[1100px] h-auto absolute top-[136px] left-[155px] border-[1px] border-transparent hover:border-[1px] hover:border-black'>
//         <div className='flex flex-col sm:flex-row items-start justify-between w-full h-auto'>

//             {/* Details */}
//             <div className='flex flex-col items-start sm:w-[733px] w-full h-auto sm:h-[547px]'>

//                 {/* Delivery */}
//                 <div className='flex flex-col items-start justify-evenly sm:w-[400px] w-full sm:h-[62px] h-auto bg-[#F5F5F5] pl-2'>
//                     <p className='text-[13px] font-medium'>Free Delivery</p>
//                     <div className='w-[280px] sm:w-full h-[24px] flex justify-between'>
//                         <p className='text-[11px] font-normal'>Applies to orders of ₹ 14 000.00 or more.</p>
//                         <p className='text-[11px] font-medium underline underline-offset-2 hover:cursor-pointer'>View details</p>
//                     </div>
//                 </div>
...
//                         <Image src={Image1} alt='' width={150} height={150}></Image>
//                         <div className='flex'>
//                             <div className=''>
...
//             {/* Summary */}
//             <div className='sm:w-[350px] w-full sm:h-[295px] flex flex-col items-start justify-between px-1 '>
//                 <h2 className='font-medium text-[21px] leading-[33px]'>Summary</h2>
...
//                 {/* Button */}
//                 <button className='w-full h-[60px] flex justify-center items-center text-[15px] rounded-[30px] font-medium leading-6 bg-[#111111] text-white'>
//                     Member Checkout
//                 </button>
//             </div>
